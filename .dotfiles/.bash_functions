...
unload_my_bashrc() {
    export PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@this_pc\[\033[00m\]:[\[\033[01;34m\]\w\[\033[00m\]]\n\n>>> $ '
}
...
git-init-repo() {
    git init -q
    gitignore venv,python,JupyterNotebooks,SublimeText,VisualStudioCode,vagrant >.gitignore
